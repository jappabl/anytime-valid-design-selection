#!/usr/bin/env python3
"""Out-of-family test of the certification-overhead law on LOCAL models.
...
Offline, deterministic. Writes results_local_law.txt.
"""
...
POOL_FILES = [("llama3.2-3b", "llm_outcomes_diverse_json_llama3.2-3b.jsonl"),
...
if __name__ == "__main__":
    ...
    print(content, end="")
    (REPO / "results_local_law.txt").write_text(content)
    print(f"\nResults written to: {REPO / 'results_local_law.txt'}")
